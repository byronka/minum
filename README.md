...
- It is [decently performant](https://blog.nelhage.com/post/reflections-on-performance/), because performance has been a target from inception. For example, 
  it can handle [18,304 web requests per second](docs/perf_data/response_speed_test.md). The [database](docs/perf_data/database_speed_test.md) can perform 2 _million_ writes per 
