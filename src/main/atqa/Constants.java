...
public class Constants {
     ...
     */
    public static final int MAX_READ_SIZE_BYTES = 10 * 1024 * 1024;

    /**
     * The most bytes we'll read as a single line
     */
    public static final int MAX_READ_LINE_SIZE_BYTES = 200;

    /**
     * A user can only provide up to this many query string keys
     */
    public static final int MAX_QUERY_STRING_KEYS_COUNT = 20;

    /**
     * Totally nonsense if we find more than this many matches of cookies in the headers.
     */
    public static final int MOST_COOKIES_WELL_LOOK_THROUGH = 5;
     ...
     */
    public static final int MAX_TOKENIZER_PARTITIONS = 20;

    /**
     * How long will we let a socket live before we crash it closed?
     * See {@link java.net.Socket#setSoTimeout(int)}
     */
    public static final int SOCKET_TIMEOUT_MILLIS = 1000 * 3;
}
